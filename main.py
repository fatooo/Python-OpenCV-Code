...
while(True):
    ...
    side_touch_w,side_touch_y,side_touch_r,touch = side_touch(center_w,velocity_x_w,velocity_y_w,center_y,velocity_x_y,velocity_y_y,center_r,velocity_x_r,velocity_y_r,i,touch)
    ...
    if (NoMotion_flag==True) or ((Move(center_prev_w[1],center_prev_w[0],center_w[1],center_w[0]) and Move(center_prev_y[1],center_prev_y[0],center_y[1],center_y[0]) and Move(center_prev_r[1],center_prev_r[0],center_r[1],center_r[0]))==False):
        ...
        if delete_flag == False:
            max_vel_y,max_vel_w,max_vel_r = demo(frame,i,data_w,data_y,data_r,velocity_w,velocity_y,velocity_r,max_vel_y,max_vel_w,max_vel_r,first_move)
    else:
        delete_flag = True
        NoMotion_flag = True
