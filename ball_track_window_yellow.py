...
w = initial_window
template_o = cv2.imread('C:\\Users\\fatma\\PycharmProjects\\pythonProject\\Templates\\yellow_big_2.png')
template_2_o = cv2.imread('C:\\Users\\fatma\\PycharmProjects\\pythonProject\\Templates\\yellow_2.png')
...
while(i<frame_amount-1):
    ...
    velocity[i] = float(math.sqrt(math.pow(abs(velocity_x[i]), 2) + math.pow(abs(velocity_y[i]), 2)))
    #print(velocity[i])
...
# np.savetxt("C:\\Users\\fatma\\PycharmProjects\\pythonProject\\Position and Velocity Data\\"+str(dateStr)+str(timeStr)+'yellow_center.csv', center[0], delimiter=",")
# np.savetxt("C:\\Users\\fatma\\PycharmProjects\\pythonProject\\Position and Velocity Data\\"+str(dateStr)+str(timeStr)+'yellow_velocity.csv', velocity, delimiter=",",fmt='%f')
np.savetxt("yellow_center.csv", center[0], delimiter=",")
